...
x_act = open("ci_x_actual_gradiente2.txt", "w")
x_des = open("ci_x_deseado_graadiente2.txt", "w")
q_act = open("ci_q_actual_gradiente2.txt", "w")
...
while not rospy.is_shutdown():
    ...
    qfinal = ik_gradient_iiwa14(xd, qfinal)
    if(qfinal[0] > 2.93):
        qfinal[0] = 2.93
    if(qfinal[1] > 2.06):
        qfinal[1] = 2.06
